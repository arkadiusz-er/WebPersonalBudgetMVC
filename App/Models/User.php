 ...
 */
 ...
 class User extends \Core\Model {
    ...
    public function validate() {
        ...
        if (static::loginExists($this->username, $this->id ?? null)) {
            $this->errors[] = 'Login już istnieje';
        } 
        ...
        if (static::emailExists($this->email, $this->id ?? null)) {
            $this->errors[] = 'Email już istnieje';
        }
        ...
        if (preg_match('/.*[a-z]+.*/i', $this->password) == 0) {
            $this->errors[] = 'Hasło musi posiadać conajmniej 1 literę';
        }
     ...
     */
    public static function loginExists($username, $ignore_id = null) {
